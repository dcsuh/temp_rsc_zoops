...
```{r}
m1_plot <- seq_plot("m1_I_end") + labs(title = paste("Constant u. AIC =", round(m1_aic, 3)))
m2_plot <- seq_plot("m2_I_end") + labs(title = paste("temp-dependent. AIC =", round(m2_aic, 3)))
...
ggsave("m1_u_fit.png", m1_plot, path=here("mle/fit_plots"))
ggsave("m2_u_fit.png", m2_plot, path=here("mle/fit_plots"))
ggsave("m3_u_fit.png", m3_plot, path=here("mle/fit_plots"))
ggsave("m4_u_fit.png", m4_plot, path=here("mle/fit_plots"))
