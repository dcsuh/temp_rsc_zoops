...
m3_f_fit <- mle2(m3_ll,
                ...
                lower = c(0, 0, 0),
                upper = c(Inf, Inf, Inf),
                control=list(parscale=c(f=40, h=100, sd_est=0.01), maxit=10000))
end_time <- Sys.time()
...
m4_f_fit <- mle2(m4_ll,
                skip.hessian = T,
                start=list(f=5, arr_t=50, h=100, sd_est=0.01),
                method = "L-BFGS-B",
                lower = c(0, 0, 0, 0),
                upper = c(Inf, Inf, Inf, Inf),
                control=list(parscale=c(f=5, arr_t=50, h=100, sd_est=0.01), maxit=10000))
end_time <- Sys.time()
