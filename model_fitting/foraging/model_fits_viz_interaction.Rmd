...
```{r}
seq_data %<>% 
  mutate(m1_consumed = resource*15/1000 - m1_R_end,
...
```{r}
algae_plot("m1_consumed") + labs("Size")
algae_plot("m2_consumed") + labs("Temp")
algae_plot("m3_consumed") + labs("Resource")
algae_plot("m4_consumed") + labs("Additive")
algae_plot("m6c_consumed") + labs("Interactive")
```
