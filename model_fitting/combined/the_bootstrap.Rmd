...
```{r}
saveRDS(beet, file = here("model_fitting", "combined", "beet", "30_060624.rds"))
mod_f_boot <- c(readRDS(file = here("model_fitting", "combined", "beet", "30_060624.rds")))
...
mod_quantiles$f[1] <- coef(m5a_u_f_fit)[1]
...
mod_quantiles$u[1] <- coef(m5a_u_f_fit)[2]
...
mod_quantiles$rho[1] <- coef(m5a_u_f_fit)[7]
...
mod_quantiles$phi[1] <- coef(m5a_u_f_fit)[8]
