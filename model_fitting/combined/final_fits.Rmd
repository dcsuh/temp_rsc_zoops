...
tmp <- data
tmp_dataset <- dataset
m5a_u_f_fit <- mle2(m5a_ll, start=list(u = 0.0001,
                                        f=30, 
                                        arr_t_f=10,
                                        arr_t_u=65,
                                        h=16000,
...
saveRDS(m5a_u_f_fit, file = here("mle","final","m5a_fit_alt1.rds"))
```
...
m5a_u_f_fit <- readRDS(file = here("mle", "final", "m5a_fit_alt1.rds"))
```
...
getAIC(m5a_u_f_fit) #arrhenius u and per-temperature rho
```
