...
u_m5a <- coef(m5a_profile)[1]
f_m5a <- coef(m5a_profile)[2]
arr_t_f_m5a <- coef(m5a_profile)[3]
arr_t_u_m5a <- coef(m5a_profile)[4]
h_m5a <- coef(m5a_profile)[5]
w_m5a <- coef(m5a_profile)[6]
rho_15_m5a <- coef(m5a_profile)[7]
rho_20_m5a <- coef(m5a_profile)[8]
rho_25_m5a <- coef(m5a_profile)[9]
