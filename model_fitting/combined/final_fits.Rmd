...
f <- m4_coef[1]*adjust_factor
u <- m4_coef[2]*adjust_factor
arr_t_f <- m4_coef[3]*adjust_factor
arr_t_u <- m4_coef[4]*adjust_factor
h <- m4_coef[5]*adjust_factor
w <- m4_coef[6]*adjust_factor
rho <- m4_coef[7]*adjust_factor
