...
m5_u_f_fit[1] <- mle2(m4_ll, start=list(u = 0.0001, f=1, arr_t_f=10, arr_t_u=10, h=1), 
                     control=list(parscale = c(u = 0.0001, f=1, arr_t_f=10, arr_t_u=10, h=1)),
                     skip.hessian=F, method="L-BFGS-B", 
                   lower=c(u = 0, f = 0, arr_t_f = 0, arr_t_u = 0, h = 0), 
                   upper=c(u = 1, f = Inf, arr_t_f = Inf, arr_t_u = Inf, h = Inf))
...
m5_u_f_fit[2] <- mle2(m4_ll, start=list(u = 0.0001, f=1, arr_t_f=10, arr_t_u=10, h=1), 
                     control=list(parscale = c(u = 0.0001, f=1, arr_t_f=10, arr_t_u=10, h=1)),
                     skip.hessian=F, method="L-BFGS-B", 
                   lower=c(u = 0, f = 0, arr_t_f = 0, arr_t_u = 0, h = 0), 
                   upper=c(u = 1, f = Inf, arr_t_f = Inf, arr_t_u = Inf, h = Inf))
...
m5_u_f_fit[3] <- mle2(m4_ll, start=list(u = 0.0001, f=1, arr_t_f=10, arr_t_u=10, h=1), 
                     control=list(parscale = c(u = 0.0001, f=1, arr_t_f=10, arr_t_u=10, h=1)),
                     skip.hessian=F, method="L-BFGS-B", 
                   lower=c(u = 0, f = 0, arr_t_f = 0, arr_t_u = 0, h = 0), 
                   upper=c(u = 1, f = Inf, arr_t_f = Inf, arr_t_u = Inf, h = Inf))
...
saveRDS(m5_u_f_fit, file = here("mle","update","m5_fit.rds"))
```
...
m5_u_f_fit <- readRDS(file = here("mle", "update", "m5_fit.rds"))
```
...
data_summ %<>% mutate(m1_rate = (m1_f*exp(m1_arr*(1/ref_t - 1/temp))*(mm_mean^gamma))/(1+m1_f*exp(m1_arr*(1/ref_t - 1/temp))*(mm_mean^gamma)*m1_h*exp(m1_w*temp)*resource*fora_vol/1000),
                      m1_u = m1_u,
...
```{r}
# m5_f_15 <- coef(m5_u_f_fit[[1]])[1]
# m5_u_15 <- coef(m5_u_f_fit[[1]])[2]
# m5_h_15 <- coef(m5_u_f_fit[[1]])[3]
# 
# m5_f_20 <- coef(m5_u_f_fit[[2]])[1]
# m5_u_20 <- coef(m5_u_f_fit[[2]])[2]
# m5_h_20 <- coef(m5_u_f_fit[[2]])[3]
# 
# m5_f_25 <- coef(m5_u_f_fit[[3]])[1]
# m5_u_25 <- coef(m5_u_f_fit[[3]])[2]
# m5_h_25 <- coef(m5_u_f_fit[[3]])[3]
# 
# data_summ %<>% mutate(m4_rate = case_when(temp==15 ~ ))
