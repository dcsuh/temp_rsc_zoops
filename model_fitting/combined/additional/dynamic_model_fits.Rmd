...
# Notes
 ...
 - try model 3 per treatment and see if it is better
 - try model 4 per treatment and see if it is better
...
```{r, m3u_ll}
m3u_ll <- function(f, u_15_0.1, u_15_0.5, u_15_1.0, u_20_0.1, u_20_0.5, u_20_1.0, u_25_0.1, u_25_0.5, u_25_1.0, h, k){
  data <- tmp
  R_end <- as.data.frame(mapply(m3_sim, R=data$amt_init*fora_vol/1000, time=data$time/60/24, f=f/fora_vol,
                                 u = 0, #u actually not important for this part. just wanted to use a single deSolve function for both
                                 length=data$mm, gamma=gamma, Z=0,
...
This version uses a half-saturation method to modify u by resources
