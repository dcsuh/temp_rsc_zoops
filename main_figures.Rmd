...
rate_5a <- rate_plot(u_seq, "m5a_rate")
...
spo_5a <- spores_plot(u_seq, "spores_consumed_m5a")
...
prev_5a <- prev_plot(u_seq, "m5a_I_end")
...
```{r}
i_d <- spores_plot(u_seq, "spores_consumed_m5") + 
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank() ,axis.title.x = element_blank(), plot.title = element_blank(), legend.position = "none")

i_e <- u_plot(u_seq, "m5_u") + 
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank() ,axis.title.x = element_blank(), plot.title = element_blank(), legend.position = "none")

i_f <- prev_plot(u_seq, "m5_I_end") + 
  theme(plot.title = element_blank(), legend.position = "none")
