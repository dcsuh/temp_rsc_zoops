...
est_m4 <- readRDS(file = here("model_fitting", "m4_coef_log_fit.rds"))
est_m4_1 <- readRDS(file = here("model_fitting", "m4_coef_fit.rds"))
est_m4_1.1 <- readRDS(file = here("model_fitting", "m4_1.1_coef_fit.rds"))
est_m4_0.5 <- readRDS(file = here("model_fitting", "m4_0.5_coef_fit.rds"))
...
seq_data %<>% mutate(m4_rate = (m4_f*exp(m4_arr*(1/ref_t - 1/temp))*
                       ...
                       (1+m4_f*exp(m4_arr*(1/ref_t - 1/temp))*
                          ...
                          m4_h*exp(m4_w*temp)*
                          resource/1000),
                     m4_u_star = m4_u*exp(m4_arr_u*(1/ref_t - 1/temp))*exp(m4_rho*resource))
...
seq_data %<>%
  mutate(amt_diff = amt_init_mean-amt_rem_mean,
         m4_diff = resource - m4_R/fora_vol*1000,
         m4_1_diff = resource - m4_1_R/fora_vol*1000,
         m4_1.1_diff = resource - m4_1.1_R/fora_vol*1000,
         m4_0.5_diff = resource - m4_0.5_R/fora_vol*1000)
