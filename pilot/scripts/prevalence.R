...
mort <- readRDS(here("pilot","processed_data", "mortality.rds"))
prevalence <- readRDS(here("pilot","processed_data", "prevalence.rds"))
treatment_factors <- readRDS(here("pilot","processed_data", "treatment_factors.rds"))
