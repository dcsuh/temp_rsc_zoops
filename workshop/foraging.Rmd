...
data_summ %<>% mutate(species = "D",
                      ID = paste(temp,resource,species, sep = "_"))
...
dnorm produces a probability density function (PDF) for observing a value assuming a normal distribution.
so dnorm will produce a vector of probabilities. 
