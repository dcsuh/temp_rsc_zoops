...
```{r}
lifespan_glm <- glm(as.numeric(span) ~ resource * temperature, data = sem_data)
length_glm <- glm(length ~ resource * temperature, data = sem_data)
yield_glm <- glm(spore_yield ~ as.numeric(span) * length, data = sem_data)
