...
*Seems like the outputs for the SEMs in markdown files just coem out weird. not sure what is up with that but the model summaries should be executed in the console*
