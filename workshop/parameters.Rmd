...
$$
```{r, read data}
fitness <- read_csv(here("raw_data/main_fitness_edit.csv"))
...
for(i in 1:length(treatments)){
  dsub <- dataset[dataset$treatment==trts[i],]
...
for (j in 1:length(treatments)){
  ...
  print("little r for one treatment done")

  
  
  print("start beta boot")
  print(j)
  ...
  print("beta for one treatment done")
