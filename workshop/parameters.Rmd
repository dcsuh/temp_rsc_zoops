...
lt.summary %>% ggplot(.,aes(x=trt, y=S.R_naught)) + geom_point() + geom_linerange(aes(ymin=S.R_naught.025, ymax=S.R_naught.975)) + theme(axis.text.x = element_text(angle=90)) + geom_hline(yintercept=1)
