...
Use bootstrap method to estimate host net reproductive rate from fecundity data using euler equation. see script for details
```{r, warning = F}
...
```{r}
little_r_U <- lt.summary_factors %>% filter(species=="daphnia", temp_var == 0, inf_status=="U") %>% 
...
ggsave("little_r.png", little_r_U, width = outwidth[1], height = outwidth[1]/golden, unit = "in", path = "/Users/dcsuh/Downloads")
