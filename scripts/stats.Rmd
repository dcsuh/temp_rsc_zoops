...
inf_glm_15 <- glm(inf ~ resource, data = prev_15, family = binomial)

prev_20 <- prevalence %>% filter(temp==20)
inf_glm_20 <- glm(inf ~ resource, data = prev_20, family = binomial)

prev_25 <- prevalence %>% filter(temp==25)
inf_glm_25 <- glm(inf ~ resource, data = prev_25, family = binomial)
