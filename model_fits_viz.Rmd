...
data_summ %<>% mutate(m7a_rate = ((m7a_f*exp(m7a_arr*(1/ref_t - 1/temp)))/
                                   (1+m7a_f*exp(m7a_arr*(1/ref_t - 1/temp))*m7a_h*resource)))

seq_data %<>% mutate(m7a_rate = ((m7a_f*exp(m7a_arr*(1/ref_t - 1/temp)))/
                                   (1+m7a_f*exp(m7a_arr*(1/ref_t - 1/temp))*m7a_h*resource)))
```

```{r, echo=F}
m7a_plot <- seq_data %>% na.omit() %>%
ggplot(.) +
geom_line(aes(x=resource, 
              y=m7a_rate,
              group=temp_factor)) +
