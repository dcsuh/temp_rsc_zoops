...
051224 - 80 iterations but with original starting parameters (h=16000)
051324 - 47 iterations but with original starting parameters as parameter estimates from model 5a
051424 - 20 iterations with model 5a parameter estimates as starting

```{r}
#saveRDS(beet, file = here("model_fitting", "combined", "beet", "47_051424.rds"))
