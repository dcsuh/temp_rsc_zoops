...
tmp <- data
tmp_dataset <- dataset
m5_u_f_fit <- mle2(m5_ll, start=list(u_15 = 0.00001,
                                     u_20 = 0.0001,
                                     u_25 = 0.001,
                                        f=5, 
                                        arr_t_f=80, 
                                     ...
                                     rho_20=-0.1,
                                     rho_25=-0.1), 
                     control=list(parscale = c(u_15 = 0.00001,
                                     u_20 = 0.00001,
                                     u_25 = 0.0001,
                                        f=1, 
                                        arr_t_f=10, 
...
```{r, 00}
  ...
  for(i in 1:iterations){
      ...
      boot_00[[i]] <- mle2(m5_ll, start=list(u_15 = 0.00001,
                                             u_20 = 0.0001,
                                             u_25 = 0.001,
                                              f=5, 
                                              arr_t_f=80, 
...
mod_quantiles$arr[1] <- coef(mod)[2]
