...
25_051624 - 25 iterations with updated starting params and higher max iter. no convergence failures. rescaled

```{r}
#saveRDS(beet, file = here("model_fitting", "combined", "beet", "20_051624.rds"))
mod_f_boot <- c(readRDS(file = here("model_fitting", "combined", "beet", "20_051524.rds")),
readRDS(file = here("model_fitting", "combined", "beet", "25_051624.rds")))
