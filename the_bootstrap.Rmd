...
```{r}
beet <- c(boot_01, boot_02, boot_03)
```
...
# mod_f_boot <- c(readRDS(file = here("model_fitting", "combined", "beet", "20_051524.rds")), readRDS(file = here("model_fitting", "combined", "beet", "20_051624.rds")))
